...
public class AdapterGroupSearchResults extends RecyclerView.Adapter<AdapterGroupSearchResults.ViewHolder> {
    private List<Group_Chat> searchResults;
    private Context context;

    public AdapterGroupSearchResults(List<Group_Chat> searchResults, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterGroupSearchResults.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Group_Chat chat = searchResults.get(position);
